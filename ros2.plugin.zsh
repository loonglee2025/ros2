...
# ---------------------------------------------------------------------------
[[ "$ROS2_ENABLE_ENV"    == "1" ]] && _ros2sc_source "$_ROS2_DIR/functions/workspace.zsh"
[[ "$ROS2_ENABLE_UTILS"  == "1" ]] && _ros2sc_source "$_ROS2_DIR/functions/helpers.zsh"

# ---------------------------------------------------------------------------
# 5. Load alias modules
# ---------------------------------------------------------------------------
[[ "$ROS2_ENABLE_CORE"      == "1" ]] && {
  _ros2sc_source "$_ROS2_DIR/aliases/topic.zsh"
  _ros2sc_source "$_ROS2_DIR/aliases/service.zsh"
  _ros2sc_source "$_ROS2_DIR/aliases/node.zsh"
  _ros2sc_source "$_ROS2_DIR/aliases/param.zsh"
  _ros2sc_source "$_ROS2_DIR/aliases/action.zsh"
}

[[ "$ROS2_ENABLE_PKG"       == "1" ]] && {
  _ros2sc_source "$_ROS2_DIR/aliases/pkg.zsh"
  _ros2sc_source "$_ROS2_DIR/aliases/interface.zsh"
}

[[ "$ROS2_ENABLE_RUN"       == "1" ]] && {
  _ros2sc_source "$_ROS2_DIR/aliases/run.zsh"
  _ros2sc_source "$_ROS2_DIR/aliases/launch.zsh"
}

[[ "$ROS2_ENABLE_BAG"       == "1" ]] && _ros2sc_source "$_ROS2_DIR/aliases/bag.zsh"
[[ "$ROS2_ENABLE_LIFECYCLE" == "1" ]] && _ros2sc_source "$_ROS2_DIR/aliases/lifecycle.zsh"
[[ "$ROS2_ENABLE_DAEMON"    == "1" ]] && _ros2sc_source "$_ROS2_DIR/aliases/daemon.zsh"
[[ "$ROS2_ENABLE_COLCON"    == "1" ]] && _ros2sc_source "$_ROS2_DIR/aliases/colcon.zsh"
[[ "$ROS2_ENABLE_UTILS"     == "1" ]] && _ros2sc_source "$_ROS2_DIR/aliases/utils.zsh"
